// Fixtures for the whole anime surface. There is no backend and no fetch layer: every screen
// in this app renders straight from here, which is what lets `pnpm dev` show a complete UI
// with nothing else running.
//
// Two filenames referenced below are MISSPELLED ON DISK -- `new_arriavals*.avif` and
// `fovorite_40dp.svg`. They are reproduced exactly as they are named in `public/`; "fixing"
// either one silently 404s the image.
import type {
  DailyEpisode,
  Day,
  FavoriteTab,
...
import type { PublicAnimeSeriesDetail } from "@/types/anime-series";
 ...
 *
 * These stand in for what was a server-fetched, admin-managed list. Four is deliberate: the
 * carousel's dots and arrows only render when `slides.length > 1`, so a single-slide fixture
 * would leave that chrome permanently untested.
 */
export const MOCK_HERO_SLIDES: HeroSlide[] = [
  {
    id: "hero-01",
    imageUrl: "/dummy/anime_hero.avif",
    title: "Now streaming: the season's most-watched debut",
    destinationPath: "/anime/watch?v=anime-free",
  },
  {
    id: "hero-02",
    imageUrl: "/dummy/spotlight_image01.avif",
    title: "Spotlight - a swordsman's last quiet morning",
    destinationPath: "/anime/watch?v=anime-free",
  },
  {
    id: "hero-03",
    imageUrl: "/dummy/spotlight_image02.avif",
    title: "New arrivals every Friday",
    destinationPath: "/anime?view=new",
  },
  {
    // Decorative on purpose: exercises the `destinationPath: null` branch, which renders a
    // plain <div> instead of a <Link>.
    id: "hero-04",
    imageUrl: "/dummy/spotlight_image03.avif",
    title: "Made with the Anime Qatoto studio",
    destinationPath: null,
  },
];

/**
 * Series detail fixtures, keyed by slug.
 *
 * The nullable fields on `PublicAnimeEpisode` are each exercised at least once on purpose:
 * `series-hero` renders a flat muted band when `posterUrl` is null, and `episode-grid` drops
 * the duration chip and the audio/age badges when those are null. A fixture set where every
 * field is populated would leave all of those branches unrendered and untested.
 */
export const MOCK_ANIME_SERIES: Record<string, PublicAnimeSeriesDetail> = {
  "ember-and-ash": {
    seriesSlug: "ember-and-ash",
    title: "Ember and Ash",
    description:
      "A disgraced court smith walks north with a blade she is forbidden to finish, trailed by the apprentice who reported her.",
    posterUrl: "/dummy/completed_series01.avif",
    genreTags: ["Fantasy", "Adventure", "Action"],
    status: "ongoing",
    ...
    seasons: [
      {
        ...
        episodes: [
          {
            episodeId: "ember-s1e1",
            videoId: "anime-free",
            episodeNumber: 1,
            episodeTitle: "The Unfinished Edge",
          ...
          {
            episodeId: "ember-s1e2",
            videoId: "anime-free",
            episodeNumber: 2,
            episodeTitle: "Nine Days of Rain",
            thumbnailUrl: "/dummy/thumbnail_image02.avif",
            durationSeconds: 1402,
            audioMode: "dubbed",
            audioLanguage: "English",
            ageRating: "PG-13",
            releasedAt: "2026-04-10T09:00:00.000Z",
          },
          {
            // No duration and no badges: the grid must render this row without them.
            episodeId: "ember-s1e3",
            videoId: "anime-free",
            episodeNumber: 3,
            episodeTitle: "What the River Kept",
      ...
      },
      {
        ...
        episodes: [
          {
            episodeId: "ember-s2e1",
            videoId: "anime-free",
            episodeNumber: 1,
            episodeTitle: "A Colder Forge",
            thumbnailUrl: "/dummy/thumbnail_image04.avif",
            durationSeconds: 3661,
            audioMode: "subbed",
            audioLanguage: "Japanese",
            ageRating: "R",
            releasedAt: "2026-07-31T09:00:00.000Z",
          },
          {
            episodeId: "ember-s2e2",
            videoId: "anime-free",
            episodeNumber: 2,
            episodeTitle: "The Apprentice's Account",
            thumbnailUrl: null,
            durationSeconds: 1380,
            audioMode: "subbed",
            audioLanguage: "Japanese",
            ageRating: "R",
            releasedAt: "2026-08-07T09:00:00.000Z",
          },
        ],
      },
    ],
  ...
  "the-quiet-tide": {
    // No poster: exercises `series-hero`'s flat muted band.
    seriesSlug: "the-quiet-tide",
    title: "The Quiet Tide",
    description: null,
    posterUrl: null,
    genreTags: ["Slice of Life", "Romance"],
    status: "completed",
...
/** Slugs that have a fixture -- used by `generateStaticParams` on the detail route. */
export const MOCK_ANIME_SERIES_SLUGS = Object.keys(MOCK_ANIME_SERIES);
